...
show_mysql_migration_instructions() {
    ...
    echo ""
    echo "Options:"
    echo "  1. Run automatic migration: /root/migrate_mysql_to_postgresql.sh"
    echo "  2. Fresh start: Complete Nextcloud setup wizard (users/settings lost,"
    echo "     but files in data directory are preserved)"
    echo ""
